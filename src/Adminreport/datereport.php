...
include "../logindb_connect.php";
  ...
  $statement = $con->prepare(
   "SELECT DISTINCT sdate, theatre_no FROM ticket WHERE movie_name = ?");
 ...
 if (!$exec)
  ...
  <form action="datereportdb.php" method="post">
  ...
  $str = $d.$theatre;
  ?>
  <option value='<?php echo $str ?>'><?php echo"Theatre ".$theatre." - ".$d?></option>
  <?php
  }
  ?>
